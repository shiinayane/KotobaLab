...
def test_to_word_record_happy_path():
...
def test_to_word_record_edge_cases():
...
def test_to_meaning_records_happy_path():
    entry = _make_parsed_entry()
...
def test_to_meaning_records_glosses_handling(glosses, expected_definition_text):
...
def test_to_meaning_records_empty_gloss():
...
def test_to_meaning_records_with_no_pos():
